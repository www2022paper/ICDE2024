...
def get_slearner_model():
    p0_input = Input(shape=(96,), name="p0_raw_features")
    treated_input = Input(shape=(1,), name="treated_input")
...
def get_uplift_rank_ali_model_with_dropout():
    feature_input = Input(shape=(16,), name="p0_raw_features")
    treated_input = Input(shape=(1,), name="treated_input")
    reward_input = Input(shape=(1,), name="reward_input") 
    ...
    p1_output =  Dense(1, name="p1", kernel_regularizer=regularizers.l2(1e-5))(dropout_1)
...
def get_uplift_rank_criteo_model_with_dropout():
    feature_input = Input(shape=(12,), name="p0_raw_features")
    treated_input = Input(shape=(1,), name="treated_input")
    reward_input = Input(shape=(1,), name="reward_input") 
...
def get_slearner_ali_model():
    p0_input = Input(shape=(16,), name="p0_raw_features")
    treated_input = Input(shape=(1,), name="treated_input")
